...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["cmp-octave"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/cmp-octave",
  ...
  ["octave.vim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/octave.vim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/vim-illuminate",
